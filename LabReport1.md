...
```
3. Share an Example of using the command with a path to a file as an argument.
The starting directory is the /home/lecture1 directory, if I type in "ls Hello.java", "ls Hello.class", "ls README",
...
```
1. Share an example of using the command with no arguments.
The starting directory of the first picture is the /home/lecture1/messages directory which contains lot of txt files. If I
...
the example is the /home/lecture1/message directory, which contains a lot of txt files. By running "cat en-us.txt" for
